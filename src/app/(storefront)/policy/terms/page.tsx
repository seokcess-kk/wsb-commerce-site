...
export default function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="text-2xl font-extrabold text-ng-charcoal">이용약관</h1>

      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제1조 목적</h2>
      <p className="text-sm leading-relaxed text-stone-600">
        이 약관은 (주)우리스마트바이오(이하 “회사”)가 운영하는 WSB 스토어(이하 “쇼핑몰”)에서
        제공하는 인터넷 관련 서비스(이하 “서비스”)의 이용 조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
      </p>

      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제2조 정의</h2>
      ...
      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제3조 약관의 효력 및 변경</h2>
      <p className="text-sm leading-relaxed text-stone-600">
      ...
      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제4조 회원가입</h2>
      <p className="text-sm leading-relaxed text-stone-600">
      ...
      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제5조 서비스 이용</h2>
      <p className="text-sm leading-relaxed text-stone-600">
      ...
      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제6조 주문 및 계약의 성립</h2>
      <p className="text-sm leading-relaxed text-stone-600">
      ...
      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제7조 결제</h2>
      <p className="text-sm leading-relaxed text-stone-600">
      ...
      <h2 className="mb-2 mt-8 text-base font-bold text-ng-charcoal">제9조 면책</h2>
      <p className="text-sm leading-relaxed text-stone-600">
